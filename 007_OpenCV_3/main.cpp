...
using std::endl;
template<class _alh>
void test_alhorithm(const char * msg,Mat & etlon,Mat & scene)
{
    time_t begin = time();    
    int minHessian = 400;
    Ptr<_alh> detector = _alh::create( minHessian );
    ...
    std::cout << "proceccing time: " <<time() - begin << endl;
...
int main( int argc, char* argv[] )
{
    ...
    // ORB / AKAZE / GFTT
    test_alhorithm<ORB>("ORB",img_object,img_scene);
